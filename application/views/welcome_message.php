...
<html lang="en">
    ...
    <body>
        ...
        <ul>
            ...
            <li><a href="<?php echo site_url('/api/example/users/id/1'); ?>">User #1</a> - defaulting to XML</li>
            <li><a href="<?php echo site_url('/api/example/users/id/1/format/json'); ?>">User #1</a> - get it in JSON</li>
